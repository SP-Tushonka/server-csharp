...
)
{
    ...
    /// </summary>
    protected readonly MongoId[] InGameTraders = [Models.Enums.Traders.LIGHTHOUSEKEEPER, Models.Enums.Traders.BTR];
    ...
    protected bool IsInGameTrader(Models.Eft.Common.Tables.Quest quest)
    {
    ...
    protected Models.Eft.Common.Tables.Quest? GetQuestFromDb(MongoId questId, PmcData pmcData)
    {
    ...
    public Models.Eft.Common.Tables.Quest ApplyMoneyBoost(
        Models.Eft.Common.Tables.Quest quest,
        double bonusPercent,
