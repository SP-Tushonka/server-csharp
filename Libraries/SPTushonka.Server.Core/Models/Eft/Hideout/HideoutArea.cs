...
public record HideoutArea
{
    ...
    public required HideoutAreas Type { get; set; }

    [JsonPropertyName("enabled")]
    public required bool IsEnabled { get; set; }

    [JsonPropertyName("needsFuel")]
    public required bool NeedsFuel { get; set; }

    [JsonPropertyName("requirements")]
    public required List<HideoutAreaRequirement> Requirements { get; set; }

    [JsonPropertyName("takeFromSlotLocked")]
    public required bool IsTakeFromSlotLocked { get; set; }

    [JsonPropertyName("craftGivesExp")]
    public required bool CraftGivesExperience { get; set; }

    [JsonPropertyName("displayLevel")]
    public required bool DisplayLevel { get; set; }

    [JsonPropertyName("enableAreaRequirements")]
    public required bool EnableAreaRequirements { get; set; }
...
public record Stage
{
    ...
    public required bool AutoUpgrade { get; set; }

    [JsonPropertyName("bonuses")]
    public required List<Bonus> Bonuses { get; set; }

    [JsonPropertyName("constructionTime")]
    public required double ConstructionTime { get; set; }

    /// <summary>
    ///     Containers inventory tpl
    /// </summary>
    [JsonPropertyName("container")]
    public required MongoId Container { get; set; }
    ...
    public required bool DisplayInterface { get; set; }

    [JsonPropertyName("improvements")]
    public required List<StageImprovement> Improvements { get; set; }

    [JsonPropertyName("requirements")]
    public required List<StageRequirement> Requirements { get; set; }
...
public record StageImprovement
{
    ...
    [JsonPropertyName("bonuses")]
    public required List<StageImprovementBonus> Bonuses { get; set; }

    [JsonPropertyName("improvementTime")]
    public required double ImprovementTime { get; set; }

    [JsonPropertyName("requirements")]
    public required List<StageImprovementRequirement> Requirements { get; set; }
}
...
public record StageImprovementRequirement
{
    ...
    public required bool IsFunctional { get; set; }

    [JsonPropertyName("templateId")]
    public MongoId TemplateId { get; set; }

    [JsonPropertyName("isSpawnedInSession")]
    public required bool IsSpawnedInSession { get; set; }
