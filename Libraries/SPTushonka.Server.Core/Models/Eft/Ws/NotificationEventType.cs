...
public enum NotificationEventType
{
    ...
    shopLabelsUpdated,
    UpdateAccountTarcoinBalance,
    UpdateAccountOfferPurchased,
    UpdateAccountOfferReceived,
    UpdateAccountTarcoinBalanceIncreased,
    OffersCompositionChanged,
    SaleContentChanged,
    MenuLabelsChanged,
    GameEditionUpgrade,
    UpdateAccountEftBattlePassUniversalDocumentBalance,
}
